...
const waterwayLensImages: readonly LensImage[] = [
  { category: "Waterways", src: "/images/lens/lens-waterways-01.png", caption: "Hogfish held up on a dock before the coastal skyline." },
  { category: "Waterways", src: "/images/lens/lens-waterways-02.png", caption: "Spearfisher displaying a hogfish in clear turquoise lagoon water." },
  { category: "Waterways", src: "/images/lens/lens-waterways-03.png", caption: "Striped snapper held up in open water beside floating speargun." },
  { category: "Waterways", src: "/images/lens/lens-waterways-04.png", caption: "Hogfish lifted from choppy ocean water beside the boat gunwale." },
  { category: "Waterways", src: "/images/lens/lens-waterways-05.png", caption: "Spearfisher treading water with speargun near a NauticStar stern." },
  { category: "Waterways", src: "/images/lens/lens-waterways-06.png", caption: "Underwater spearfisher with speargun and catch in turquoise lagoon." },
  { category: "Waterways", src: "/images/lens/lens-waterways-07.png", caption: "Snorkeler holding a hogfish beneath bright sunlit lagoon surface." },
  { category: "Waterways", src: "/images/lens/lens-waterways-08.png", caption: "NauticStar drifting on calm blue water with diver climbing aboard." },
  { category: "Waterways", src: "/images/lens/lens-waterways-09.png", caption: "Speared hogfish held underwater with bubbles rising toward the surface." },
  { category: "Waterways", src: "/images/lens/lens-waterways-10.png", caption: "Two hogfish displayed on the boat against a distant coastal skyline." },
  { category: "Waterways", src: "/images/lens/lens-waterways-11.png", caption: "Fresh snapper filleted at a marina dock beneath billowing clouds." },
  { category: "Waterways", src: "/images/lens/lens-waterways-12.png", caption: "Hogfish and bar jack held up on a sunny waterfront dock." },
  { category: "Waterways", src: "/images/lens/lens-waterways-13.png", caption: "Close hogfish portrait with dock filleting blurred in background." },
  { category: "Waterways", src: "/images/lens/lens-waterways-14.png", caption: "Hogfish held from the boat seat with diving fins nearby." },
  { category: "Waterways", src: "/images/lens/lens-waterways-15.png", caption: "Hogfish displayed on the stern deck before a distant beach skyline." },
  { category: "Waterways", src: "/images/lens/lens-waterways-16.png", caption: "Spearfisher gliding over seagrass with speargun tucked on belt." },
  { category: "Waterways", src: "/images/lens/lens-waterways-17.png", caption: "Spearfisher swimming over coral reef with wooden speargun extended." },
  { category: "Waterways", src: "/images/lens/lens-waterways-18.png", caption: "Hogfish raised in open ocean beside speargun and boarding ladder." },
  { category: "Waterways", src: "/images/lens/lens-waterways-19.png", caption: "Speared hogfish held up in rippling ocean beside green-banded speargun." },
  { category: "Waterways", src: "/images/lens/lens-waterways-20.png", caption: "Sea turtle tucked beneath a rocky coral overhang on sandy bottom." },
  { category: "Waterways", src: "/images/lens/lens-waterways-21.png", caption: "Mottled filefish hovering above branching soft corals on the reef." },
  { category: "Waterways", src: "/images/lens/lens-waterways-22.png", caption: "Mixed reef catch laid out on stone beside boat ladder rails." },
  { category: "Waterways", src: "/images/lens/lens-waterways-23.png", caption: "Hogfish held between twin Yamaha outboards on choppy open ocean." },
];
...
const waterfrontImages: readonly { src: string; alt: string }[] = [
  ...
  { src: "/images/waterfront/waterfront-30.png", alt: "Striped snapper held up in open water beside floating speargun" },
  { src: "/images/waterfront/waterfront-31.png", alt: "Hogfish lifted from choppy ocean water beside the boat gunwale" },
  { src: "/images/waterfront/waterfront-32.png", alt: "Spearfisher treading water with speargun near a NauticStar stern" },
  { src: "/images/waterfront/waterfront-33.png", alt: "Underwater spearfisher with speargun and catch in turquoise lagoon" },
  { src: "/images/waterfront/waterfront-34.png", alt: "Snorkeler holding a hogfish beneath bright sunlit lagoon surface" },
  { src: "/images/waterfront/waterfront-35.png", alt: "NauticStar drifting on calm blue water with diver climbing aboard" },
  { src: "/images/waterfront/waterfront-36.png", alt: "Speared hogfish held underwater with bubbles rising toward the surface" },
  { src: "/images/waterfront/waterfront-37.png", alt: "Two hogfish displayed on the boat against a distant coastal skyline" },
  { src: "/images/waterfront/waterfront-38.png", alt: "Fresh snapper filleted at a marina dock beneath billowing clouds" },
  { src: "/images/waterfront/waterfront-39.png", alt: "Hogfish and bar jack held up on a sunny waterfront dock" },
  { src: "/images/waterfront/waterfront-40.png", alt: "Close hogfish portrait with dock filleting blurred in background" },
  { src: "/images/waterfront/waterfront-41.png", alt: "Hogfish held from the boat seat with diving fins nearby" },
  { src: "/images/waterfront/waterfront-42.png", alt: "Hogfish displayed on the stern deck before a distant beach skyline" },
  { src: "/images/waterfront/waterfront-43.png", alt: "Spearfisher gliding over seagrass with speargun tucked on belt" },
  { src: "/images/waterfront/waterfront-44.png", alt: "Spearfisher swimming over coral reef with wooden speargun extended" },
  { src: "/images/waterfront/waterfront-45.png", alt: "Hogfish raised in open ocean beside speargun and boarding ladder" },
  { src: "/images/waterfront/waterfront-46.png", alt: "Speared hogfish held up in rippling ocean beside green-banded speargun" },
  { src: "/images/waterfront/waterfront-47.png", alt: "Sea turtle tucked beneath a rocky coral overhang on sandy bottom" },
  { src: "/images/waterfront/waterfront-48.png", alt: "Mottled filefish hovering above branching soft corals on the reef" },
  { src: "/images/waterfront/waterfront-49.png", alt: "Mixed reef catch laid out on stone beside boat ladder rails" },
  { src: "/images/waterfront/waterfront-50.png", alt: "Hogfish held between twin Yamaha outboards on choppy open ocean" },
];
...
const GARDEN_ALTS: readonly string[] = [
  ...
  "Small lime-green tree in a black nursery pot on concrete beside artificial turf",
  "Passionfruit vine climbing chicken wire trellis on a weathered wooden fence",
  "Pinkish-red flower buds forming on a leafy tree branch against clear blue sky",
  "Young sprout in a nursery pot at the base of a tree with white fuzzy stem coating",
  "Orchard swallowtail caterpillar with mottled head resting on a citrus branch",
  "White five-petaled papaya flower blooming from the ridged green trunk",
  "Young papaya tree with pale blossoms and hollow leaf stems in a sunny yard",
  "Pink and orange zinnias with a monarch butterfly before a bamboo fence",
  "Pink-and-white starfruit blossom among glossy green leaves in bright sun",
  "Pale green papaya flower buds forming at branch junctions on a light green trunk",
  "Tiny striped watermelon growing on a vine in a wood-chip mulch bed",
  "Mulched garden bed with marigolds, young pineapples, and striped sugarcane",
  "Multi-stemmed fruit tree in a mulched bed with greenhouse and reed fence",
  "Young peach or nectarine tree in a mulched backyard with a boat on the lawn",
  "Brown anole perched on a wet young watermelon in the mulch garden",
  "Two yellow Labs resting in the shade beneath an olive tree on the lawn",
  "Fruit tree base with pineapple rosettes, baby watermelon vine, and marigolds",
];
